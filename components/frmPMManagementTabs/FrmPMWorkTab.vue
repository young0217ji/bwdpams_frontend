          ...
          <CardBody :style="{ width: '100%', height: '100%' }">
            <v-row>
              <v-col cols="12" align="left">
                <CardTitle>{{ $t("MES_CommLang.MES_CommLang_00033") }}</CardTitle> <!-- 예방보전일정 목록 -->
              </v-col>
            </v-row>
              ...
              <v-col col="12" align="left">
                <div class="inline-flex-wrap">
                  <div class="form-chk">
                    ...
                    <label>{{ $t("MES_CommLang.MES_CommLang_00026") }}</label> <!-- 예방보전 예정일 -->
                  </div>
          ...
          <CardBody :style="{ width: '100%', height: '100%' }">
            ...
            <div class="detail-area">
              <div class="left-area">
                <div class="area-form">
                    <div class="area-th">
                        <label style="float: right; margin-top: 8px;">{{ $t("MES_CommLang.MES_CommLang_00619") }}</label> <!-- 예방보전 일정코드 -->
                    </div>
                ...
                <div class="area-form">
                  <div class="area-th">
                    <label>{{ $t("MES_CommLang.MES_CommLang_00037") }}</label> <!-- 예방보전코드 -->
                  </div>
                  <div class="area-td">
                    <inputText
                  ...
                  <div class="area-th">
                    <label>{{ $t("MES_CommLang.MES_CommLang_00598") }}</label> <!-- 예방보전코드명 -->
                  </div>
                  <div class="area-td">
                    <inputText
                ...
                <div class="area-form">
                  <div class="area-th">
                    <label>{{ $t("MES_CommLang.MES_CommLang_00620") }}</label> <!-- 소요예상시간 -->
                  </div>
                  <div class="area-td">
                    <inputText
                  ...
                  <div class="area-th">
                    <label>{{ $t("MES_CommLang.MES_CommLang_00036") }} </label> <!-- 예방보전상태 -->
                  </div>
                  <div class="area-td">
                    <inputText
                      ref="intputNowStatus"
                ...
                <div class="area-form">
                  <div class="area-th">
                    <label>{{ $t("MES_CommLang.MES_CommLang_00038") }}</label> <!-- 예방보전주기 -->
                  </div>
                  <div class="area-td">
                    <inputText
                      ref="intputPmCycle"
                  ...
                  <div class="area-th">
                    <label>{{ $t("MES_CommLang.MES_CommLang_00027") }}</label> <!-- 예방보전구분 -->
                  </div>
                  <div class="area-td">
                    <inputText
                      ref="intputPmType"
                ...
                <div class="area-form">
                  ...
                  <div class="area-th">
                    <label>{{ $t("MES_CommLang.MES_CommLang_00507") }}</label> <!-- 최근예방보전 -->
                  </div>
                  <div class="area-td">
                    <inputText 
                  ...
                  <div class="area-th" >
                    <label>{{ $t("MES_CommLang.MES_CommLang_00034") }}</label> <!-- 예방보전일정 -->
                  </div>
                  <div class="area-td">
                    <inputText
                ...
                <div class="area-form">
                  <div class="area-th">
                    <label>{{ $t("MES_CommLang.MES_CommLang_00357") }}</label>  <!-- 관리자 -->
                  </div>
                  <div class="area-td">
                    <inputText
                      ref="intputManager"
            ...
            <div class="detail-area" style="margin-top: 5px;">
              <div class="area-form" style="height: 130px">
                <div class="area-th">
                  <label>{{ $t("MES_CommLang.MES_CommLang_00286") }}</label> <!-- 지시사항 -->
                </div>
                <div class="area-td">
                  <TextArea
                    :auto-size="false"
                ...
                <div class="area-th">
                  <label>{{ $t("MES_CommLang.MES_CommLang_00239") }}</label> <!-- 작업결과 -->
                </div>
                <div class="area-td">
                  <TextArea
                    :auto-size="false"
  ...
  export default {
    ...
    methods: {
      ...
      startBtn() {
        ...
        this.$refs['confirmPop'].message = this.$i18n.t('MES_MsgLang.MES_MsgLang_00240'); /* 예방보전작업을 시작하시겠습니까? */
      ...
      endBtn() {
        ...
        this.visibleDialog = !this.visibleDialog;
        this.$refs['confirmPop'].title = "Info";
        this.$refs['confirmPop'].message = this.$i18n.t('MES_MsgLang.MES_MsgLang_00241'); /* 예방보전작업을 종료하시겠습니까? */
      ...
      cancelBtn() {
        ...
        this.visibleDialog = !this.visibleDialog;
        this.$refs['confirmPop'].title = "Info";
        this.$refs['confirmPop'].message = this.$i18n.t('MES_MsgLang.MES_MsgLang_00242'); /* 예방보전작업을 정말 취소하시겠습니까? */
      ...
      saveCancel (commentData) {
        ...
        let cellType = "";
        const data = this.gridData.filter(x => x.PMSCHEDULEID == this.pmScheduleId);
        if(data[0].PMSTATE == this.$i18n.t('MES_CommLang.MES_CommLang_00290')){ /* 진행중 */
          cellType = "PMStartCancel";
        }else if(data[0].PMSTATE == this.$i18n.t('MES_CommLang.MES_CommLang_00495')){ /* 완료 */
      ...
      saveStart(){
        ...
        .map(x => {
          return { 
            ...
            PMSTARTTIME: this.intputWorkDateYYYYMMDD.replaceAll('-', '') + this.intputWorkDateHHMMSS.replaceAll(':', ''), // 작업일시
      ...
      async inputAreaControll (data, flag) {
        ...
        // console.log("input flag :::::::", flag);
            ...
            this.intputRecentPMYYYYMMDD  = Utility.setFormatDate(data.LASTMAINTENANCETIME,"YYYY-MM-DD"); // 최근PM 년 월 일
            ...
            if(data.PMSTATE == this.$i18n.t('MES_CommLang.MES_CommLang_00495')) { /* 완료 */
            ...
            } else if (data.PMSTATE == this.$i18n.t('MES_CommLang.MES_CommLang_00423')) { /* 미진행 */
            ...
            } else if (data.PMSTATE == this.$i18n.t('MES_CommLang.MES_CommLang_00290')) { /* 진행중 */
              this.workDateReadonly = false;
              this.instructionsTextAreaReadonly = true;
              this.workCommentReadonly = false;
              this.startBtnDisabled = true;
