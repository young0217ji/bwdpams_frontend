<template>
    <div>
                            ...
                            <div class="left-area">
                                ...
                                <div class="area-form">
                                    ...
                                    <div class="area-td">
                                        ...
                                        @input-text-set="searchInput"
                                        style="float: left; margin-right: -30px;" />
                                        <Button :theme-color="'primary'" :size="'small'" :icon="'add'" :disabled="disablePMCodeBtn" :style="{ width: '25px', float: 'left', marginTop:'5px' }" @click="$event => pmCodeModalVisible = true"></Button>
                                    </div>
                                    <div class="area-th">
                                ...
                                <div class="area-form">
                                        <div class="area-th">
                                            <label style="float: left; margin-top: 8px;">{{ $t('MES_CommLang.MES_CommLang_00487') }}</label> <!-- 비고 -->
                                        </div>
                                        <div class="area-td area-full">
                                            <TextArea 
                                            :auto-size="false" 
        ...
        />
        <SelectPMCodeModal ref="SelectPMCodeModal" v-if="pmCodeModalVisible" :visibleDialog="pmCodeModalVisible"
        :title="pmCodeDetailModalTitle" 
        @visibleDialog="val => (pmCodeModalVisible = val)" @selectedPMCode="selectedPMCode" />
    </div>
</template>
<script>
        ...
        methods: {
            setInputBox (inputData, btnFlag) {
                ...
                if(this.rightClickPlanData.length > 0){
                    ...
                    this.readonlyPmScheduleHHmmss = false;
                    this.intputPmType = "Manual";
                    this.intputPmScheduleYYYYMMDD =  Utility.setFormatDate(this.rightClickPlanData.dt, "YYYY-MM-DD");
                    this.intputPmScheduleHHmmss =  Utility.setFormatDate("000000", "HH:mm:ss");
                }
            ...
            confirmWorker () {
                ...
                } else if(this.intputEquipmentType == "" || this.intputEquipmentType == null) {
                    this.$refs.alertPop.show("Info", this.$i18n.t('MES_MsgLang.MES_MsgLang_00244')); /* 예방보전코드를 선택해 주십시오 */
                    this.$refs.alertPop.visibleDialog = true;
