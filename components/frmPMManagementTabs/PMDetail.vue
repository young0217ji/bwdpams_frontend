                    ...
                    <v-row class="search-box" align="center" no-gutters :style="{ width:'100%', marginBottom: '10px', marginRight:'15px'}">
                        <v-col :sm="12" :lg="12" align="right">
                            <div :style="{float:'right'}">
                                <Button :theme-color="'primary'" :size="'medium'" icon="save" @click="confirmWorker" >{{ $t('MES_CommLang.MES_CommLang_00414') }}</Button> <!-- 저장 -->
                        ...
                        <div class="detail-area">
                            <div class="left-area">
                                <div ref="PMCodeArea">
                                    <div class="area-form">
                                        <div class="area-th">
                                            <label style="float: left; margin-top: 8px;">{{ $t('MES_CommLang.MES_CommLang_00619') }}</label> <!-- 예방보전 일정코드 -->
                                        </div>
                                ...
                                <div class="area-form">
                                    <div class="area-th">
                                        <label style="float: left; margin-top: 5px; margin-right: 5px;">{{ $t('MES_CommLang.MES_CommLang_00177') }}</label> <!-- 설비코드 -->
                                    </div>
                                    <div class="area-td">
                                        <inputText 
                                        ...
                                        <Button :theme-color="'primary'" :size="'small'" :icon="'add'" :disabled="disableEquipmentCodeBtn" :style="{ width: '25px', float: 'left', marginTop:'5px' }" @click="$event => selectEquipmentModalVisible = true"></Button>
                                    </div>
                                    <div class="area-th">
                                        <label style="float: left; margin-top: 5px; margin-right: 5px;">{{ $t('MES_CommLang.MES_CommLang_00171') }}</label> <!-- 설비명 -->
                                    </div>
                                    <div class="area-td">
                                        <inputText
                                ...
                                <div class="area-form">
                                    <div class="area-th">
                                        <label style="float: left; margin-top: 5px; margin-right: 5px;">{{ $t('MES_CommLang.MES_CommLang_00598') }}</label> <!-- 예방보전코드 -->
                                    </div>
                                    <div class="area-td">
                                        <inputText
                                    ...
                                    <div class="area-th">
                                        <label style="float: left; margin-top: 5px; margin-right: 5px;">{{ $t('MES_CommLang.MES_CommLang_00598') }}</label> <!-- 예방보전코드명 -->
                                    </div>
                                    <div class="area-td">
                                        <inputText 
                                ...
                                <div class="area-form">
                                    <div class="area-th">
                                        <label style="float: left; margin-top: 5px; margin-right: 5px;">{{ $t('MES_CommLang.MES_CommLang_00620') }}</label> <!-- 소요예상시간 -->
                                    </div>
                                    <div class="area-td">
                                        <inputText
                                    ...
                                    <div class="area-th">
                                        <label style="float: left; margin-top: 5px; margin-right: 5px;">{{ $t('MES_CommLang.MES_CommLang_00036') }}</label> <!-- 예방보전상태 -->
                                    </div>
                                    <div class="area-td">
                                        <inputText 
                                        ref="intputPMStatus" 
                                ...
                                <div class="area-form">
                                    <div class="area-th">
                                        <label style="float: left; margin-top: 5px; margin-right: 5px;">{{ $t('MES_CommLang.MES_CommLang_00038') }}</label> <!-- 예방보전주기 -->
                                    </div>
                                    <div class="area-td">
                                    ...
                                    <div class="area-th">
                                        <label style="float: left; margin-top: 5px; margin-right: 5px;">{{ $t('MES_CommLang.MES_CommLang_00027') }}</label> <!-- 예방보전구분 -->
                                    </div>
                                    <div class="area-td">
                                        <inputText 
                                        ref="intputPmType" 
                                ...
                                <div class="area-form">
                                    <div class="area-th">
                                        <label style="float: left; margin-top: 5px; margin-right: 5px;">{{ $t('MES_CommLang.MES_CommLang_00507') }}</label> <!-- 최근예방보전 -->
                                    </div>
                                    <div class="area-td area-full">
                                        <inputText 
                                    ...
                                    <div class="area-th">
                                        <label style="float: left; margin-top: 5px; margin-right: 5px;">{{ $t('MES_CommLang.MES_CommLang_00034') }}</label> <!-- 예방보전일정 -->
                                    </div>
                                    <div class="area-td area-full">
                                        <inputText 
                                ...
                                <div class="area-form">
                                    <div class="area-th">
                                        <label style="float: left; margin-top: 5px; margin-right: 5px;">{{ $t('MES_CommLang.MES_CommLang_00028') }}</label> <!-- 예방보전시작 -->
                                    </div>
                                    <div class="area-td area-full">
                                        <inputText 
                                    ...
                                    <div class="area-th">
                                        <label style="float: left; margin-top: 5px; margin-right: 5px;">{{ $t('MES_CommLang.MES_CommLang_00031') }}</label> <!-- 예방보전완료 -->
                                    </div>
                                    <div class="area-td area-full">
                                        <inputText 
                                ...
                                <div class="area-form">
                                    <div class="area-th">
                                        <label style="float: left; margin-top: 5px; margin-right: 5px;">{{ $t('MES_CommLang.MES_CommLang_00357') }}</label> <!-- 관리자 -->
                                    </div>
                                    <div class="area-td">
                                        <inputText 
                                        ref="intputManager" 
                                    ...
                                    <div class="area-th">
                                        <label style="float: left; margin-top: 5px; margin-right: 5px;">{{ $t('MES_CommLang.MES_CommLang_00233') }}</label> <!-- 작업자 -->
                                    </div>
                                    <div class="area-td">
                                        <inputText 
                                        ref="intputWorker" 
                                ...
                                <div class="area-form" :style="{height: '110px'}">
                                    <div class="area-th">
                                        <label style="float: left; margin-top: 5px; margin-right: 5px;">{{ $t('MES_CommLang.MES_CommLang_00286') }}</label> <!-- 지시사항 -->
                                    </div>
                                    <div class="area-td">
                                        <TextArea 
                                        :auto-size="false" 
                                    ...
                                    <div class="area-th">
                                        <label style="float: left; margin-top: 5px; margin-right: 5px;">{{ $t('MES_CommLang.MES_CommLang_00239') }}</label> <!-- 작업결과 -->
                                    </div>
                                    <div class="area-td">
                                        <TextArea 
                                        :auto-size="false" 
        ...
        methods: {
            setInputBox (inputData, btnFlag) {
                ...
                if (btnFlag == "C") {
                    ...
                    this.intputPmCycle              = this.rightClickPlanData[0].pmcyclevalue + this.rightClickPlanData[0].pmcycletypename; // 예방보전주기
            ...
            confirmWorker () {
                ...
                if (this.intputEquipmentCode == "" || this.intputEquipmentCode == null) {
                    this.$refs.alertPop.show("Info", this.$i18n.t('MES_MsgLang.MES_MsgLang_00092')); /* 설비코드를 선택해 주십시오 */
                    ...
                    this.$refs['confirmPop'].message = this.$i18n.t('MES_MsgLang.MES_MsgLang_00132'); /* 작업자를 선택하지 않았습니다. 그대로 저장하시겠습니까? */
                    ...
                    // this.visibleDialog = !this.visibleDialog;
                    this.$refs['confirmPop'].title = "Warning";
                    this.$refs['confirmPop'].message = this.$i18n.t('MES_MsgLang.MES_MsgLang_00013'); /* 예방보전일정시간이 현재시각 보다 작습니다.\n그래도 진행하시겠습니까? */
                    this.$refs['confirmPop'].callBack = this.save;
                    this.$refs['confirmPop'].modalWidth = "300px";
                    this.$refs['confirmPop'].visibleDialog = true;
                } else {
