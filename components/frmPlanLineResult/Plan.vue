    ...
    data() {
      return {
        ...
        headerParam: [
            ...
            { field: 'ITEMSPEC', title: this.$i18n.t('MES_CommLang.MES_CommLang_00818'), width: '80px', editable: false, className:"gridTextCenter" }, // 규격
            { field: 'PRODUCTID', title: this.$i18n.t('MES_CommLang.MES_CommLang_00545'), width: '100px', editable: false, className:"gridTextCenter" }, // 품번
            { field: 'PRODUCTNAME', title: this.$i18n.t('MES_CommLang.MES_CommLang_00553'), width: '200px', editable: false, className:"gridTextCenter"}, // 품명
            { field: 'SUSPENSE', title: this.$i18n.t('MES_CommLang.MES_CommLang_00821'), width: '80px', editable: false, className: "gridTextRight"}, // 미결
        ],  
        oriHeaderParam: [
            { field: 'PLANOPERNAME', title: this.$i18n.t('MES_CommLang.MES_CommLang_00052'), width: '100px', editable: false, className:"gridTextCenter" }, // 공정
            { field: 'WORKCENTERNAME', title: this.$i18n.t('MES_CommLang.MES_CommLang_00805'), width: '100px', editable: false, className:"gridTextCenter" }, // 라인
