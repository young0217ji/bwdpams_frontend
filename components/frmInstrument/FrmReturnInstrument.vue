<template>
    <div>
        <Dialog v-if="visibleDialog" :title="$t('MES_CommLang.MES_CommLang_00929')" width="55%" height="250"
            @close="toggleDialog">
            <v-row no-gutters style="margin-bottom: -7px;">
                <v-col cols="6" align="left">
                    <CardTitle style="margin-bottom: -10px;"> {{ $t("MES_CommLang.MES_CommLang_00929") }}</CardTitle>
                    <!-- 반납등록 -->
                </v-col>
                            ...
                            <v-row no-gutters>
                                <v-col :cols="12">
                                    <div class="form-group-wrap" style="margin-bottom: 5px;">
                                        ...
                                        <div class="form-group">
                                            <label> {{ $t("MES_CommLang.MES_CommLang_00928") }}</label> <!-- 반납업체 -->
            ...
            const res = this.mesPost({
                ...
                this.$nextTick(() => {
                    if (result.returncode !== undefined && result.returncode === '0') {
                        ...
                        this.$emit('returninstrumentDetail', true)
                        this.$emit('visibleDialog', !this.visibleDialog)
                    } else {
