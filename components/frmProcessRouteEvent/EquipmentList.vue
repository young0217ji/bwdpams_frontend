        ...
        <v-row>
          <v-col :cols="4">
            <v-row>
              <v-col :cols="3">
                <Label>
                  {{ $t("MES_CommLang.MES_CommLang_00177") }}<!--설비코드-->
                </Label>
              </v-col>
              <v-col :cols="9">
                <InputText
            ...
            <v-row>
              ...
              <v-col :cols="11">
                <Label style="padding-left:5px;">
                  {{ $t("MES_CommLang.MES_CommLang_00501") }}<!--설비코드-->
                </Label>
              </v-col>
            </v-row>
          </v-col>
          ...
          <v-col :cols="5" align="right">
            <Button :theme-color="'primary'" :size="'medium'" icon="search" @click="search" >{{ $t("MES_CommLang.MES_CommLang_00277") }}<!--조회--></Button>
            <Button :theme-color="'primary'" :size="'medium'" icon="save"  @click="select">{{ $t("MES_CommLang.MES_CommLang_00169") }}<!--선택--></Button>
          </v-col>
        </v-row>
...
export default {
  ...
  methods: {
    ...
    async search(){
      ...
      const qyeryId = this.equipAll ? "GetEquipmentList" : "GetAvailableEquipmentList"
