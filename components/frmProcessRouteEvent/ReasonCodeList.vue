      ...
      <CardBody :style="{width:'100%'}">
        <v-row>
          ...
          <v-col :cols="5" align="right">
            <Button :theme-color="'primary'" :size="'medium'" icon="search" @click="search" >{{ $t("MES_CommLang.MES_CommLang_00277") }} </Button><!--조회-->
            <Button :theme-color="'primary'" :size="'medium'" icon="save"  @click="select">{{ $t("MES_CommLang.MES_CommLang_00169") }}</Button><!--선택-->
          </v-col>
        </v-row>
