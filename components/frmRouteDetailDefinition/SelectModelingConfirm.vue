    ...
    >
      <v-row no-gutters>
        <v-col :sm="9" :lg="9">
          ...
          <div class="form-group-wrap">
            <div class="form-group">
              <label>{{ $t("MES_CommLang.MES_CommLang_00263") }}</label><!--제품코드-->
              <InputText
                ref="productid"
                :dataNm="'productid'"
                :disabled="false"
  ...
  methods: {
    ...
    rowdblclick(event) {
      if(event.dataItem.PROCESSROUTEID === null){
        this.$refs['alertPop'].show($t("MES_CommLang.MES_CommLang_00456"), $t("MES_MsgLang.MES_MsgLang_00045"));// 알림, 라우팅설정이 안되어 있습니다. 확인해주시기 바랍니다.
        return;
      }
    ...
    selectRow() {
      ...
      if(returnData.length === 0){
        this.$refs['alertPop'].show($t("MES_CommLang.MES_CommLang_00456"), $t("MES_MsgLang.MES_MsgLang_00085"));// 알림, 선택된 제품이 없습니다.
        return;
      }
