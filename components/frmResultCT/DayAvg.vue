  ...
  <div :style="{ height: '100%' }">
    <v-row ref="contents" no-gutters :style="{ height: '100%' }">
      <v-col :cols="12" :style="{ height: '100%' }">
        <v-row
          no-gutters
          :style="{ margin: '10px 0 0 0', height: 'calc(100% - 5px)' }"
        >
          <v-col cols="12" :style="{ height: '100%' }">
...
export default {
  ...
  data() {
    return {
      ...
      commonflag: '',
      headerParam: {
        gridid: 'dgvResultCTDayAvg', // 그리드 ID
  ...
  methods: {
    ...
    async getGridData() {
      ...
      if (
        ...
        this.searchData.EQUIPMENTID == undefined ||
        this.searchData.PROCESSID == '' ||
        this.searchData.PROCESSID == undefined
      ) {
