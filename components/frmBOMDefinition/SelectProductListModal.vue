        ...
        <v-col :sm="9" :lg="10" align="left">
          <div class="form-group-wrap">
            <div class="form-group">
              ...
              <DropDownList ref="cmbProGroup" :style="{ width: '200px' }" :data-items="productGroup" :text-field="'text'"
          ...
          <div class="form-group-wrap">
            <div class="form-group" style="margin-right: 34px;">
              ...
              <InputText ref="productid" :boxWidth="'100%'" :dataNm="'productid'" :disabled="false" :searchOption="true"
