  ...
  data() {
    return {
      gridHeader: [
        ...
        {field: "REASONCODE", editable: false, title: "사유코드", width: 450, cell: "", className: "gridTextCenter",},
        {field: "DESCRIPTION", editable: false, title: "사유코드명", width: 450, cell: "", className: "gridTextCenter" }
      ],
      gridData: [],
      gridOriData: [],
      gridDropDownList: [],
  ...
  methods: {
    ...
    async getGridData() {
      this.mesGet({
        ...
        const data = res
          .filter((x) => x.REASONCODETYPE === "BONUS")
