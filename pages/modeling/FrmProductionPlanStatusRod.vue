<template>
  <div>
    <ol class="page-navigation">
      ...
      <li>{{ $t("MES_CommLang.MES_CommLang_00799") }}</li> <!-- ROD 생산순서 관리 -->
    </ol>
  ...
  data() {
    return {
      ...
      gridHeader: [
          ...
          { field: "AREAID", title:"W/C코드", width:120, editable:false, locked:true },
  ...
  methods: {
    ...
    async getWorkCenterListData() {
      this.mesGet({
        ...
        res.filter(x => x.CODE === 'P010' || x.CODE === 'P080').map(x=>{
