<template>
    <div>
        <ol class="page-navigation">
            ...
            <li>{{ $t("MES_CommLang.MES_CommLang_00295") }}</li> <!--창고기준정보-->
        </ol>
                            ...
                            <v-col :sm="9" :lg="10" align="left">
                                <div class="form-group-wrap">
                                    <div class="form-group">
                                        ...
                                        <inputText ref="warehouseId" :boxWidth="'100%'" :dataNm="'warehouseId'"
                                            :disabled="false" :searchOption="true" :searchFunc="searchBtn"
                    ...
                    <CardBody :style="{ width: '100%' }">
                        <v-row>
                            <v-col cols="6" align="left">
                                <CardTitle>{{ $t("MES_CommLang.MES_CommLang_00297") }}</CardTitle>
                            </v-col>
                        ...
                        <div ref="divWrapper" :style="{ height: 'calc(100% - 33px)' }">
                            <KendoGrid ref="rowGrid" :gridItems="gridData" :sortable="true" :resizable="true" :gridPageData="gridPageData"
                                ...
                                @gridButtonClick="gridButtonClick" @sortChangeHandler="sortChangeHandler"
                                @headerselectionchange="onHeaderSelectionChange" @pageChangeEvent="pageChangeEvent" />
                        </div>
                    </CardBody>
                </Card>
            </v-col>
        ...
        delBeforChk() {
            if (this.gridData.filter(x => x.selected).length > 0) {
                if (this.gridData.filter(x => x.selected && !x.newRow).length > 0) {
                    ...
                    this.$refs['confirmPop'].message = selectedTitle + ' - ' + this.$i18n.t('MES_MsgLang.MES_MsgLang_00089')
