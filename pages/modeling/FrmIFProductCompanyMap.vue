<template>
  <div>
    <ol class="page-navigation">
      ...
      <li>{{ $t("MES_CommLang.MES_CommLang_00559") }}</li> <!-- 품목별 업체관리 -->
    </ol>
          ...
          <CardBody :style="{ width: '100%', height: '100%' }">
            <v-row no-gutters>
              <v-col cols="6" align="left">
                <CardTitle>{{ $t("MES_CommLang.MES_CommLang_00558") }}</CardTitle> <!-- 업체목록 -->
              </v-col>
...
export default {
  ...
  data() {
    return {
      ...
      headerParam: {
        gridid: 'dgvIFProductCompanyMap', // 그리드 ID
  ...
  methods: {
    ...
    async getGridData() {
      ...
      this.mesGet({
        ...
        queryId: 'GetIFProductCompanyMap',
        sendParam: {
