<template>
  <div>
    <ol class="page-navigation">
      ...
      <li>{{ $t("MES_CommLang.MES_CommLang_00147") }}</li><!--사유코드기준정보-->
    </ol>
      ...
      <v-col :cols="3" :style="{ height: '100%' }">
        <Card ref="gridCard" :style="{ height: '100%' }">
          <CardBody :style="{ width: '100%' }">
            <v-row>
              <v-col align="left">
                <CardTitle>{{ $t("MES_CommLang.MES_CommLang_00145") }}</CardTitle><!--사유구분목록-->
              </v-col>
              <v-col align="right">
                <Button :style="{ width:'25px' }" :theme-color="'primary'" :size="'small'" @click="maximizeTree">{{this.treeBtn}}</Button>
                <Button :theme-color="'primary'" :size="'small'" @click="reasonCodeTypeModal = true">{{ $t("MES_CommLang.MES_CommLang_00549") }}</Button><!--사유구분관리-->
              </v-col>
            </v-row>
          ...
          <CardBody :style="{ width: '100%' }">
            <v-row>
              <v-col cols="6" align="left">
                <CardTitle>{{ $t("MES_CommLang.MES_CommLang_00146") }}</CardTitle><!--사유구분목록-->
              </v-col>
...
import ReasonCodeType from "@/components/frmReasonCode/ReasonCodeType";
  ...
  methods: {
    ...
    addBtn() {
      ...
      const dataItem = {
        ...
        REASONCODE: "",
        SUPERREASONCODE:this.treeActiveItem.REASONCODETYPE==='ReasonType' ? null : this.treeActiveItem.REASONCODE,
        REASONCODETYPE:this.treeActiveItem.REASONCODETYPE==='ReasonType' ? this.treeActiveItem.REASONCODE :this.treeActiveItem.REASONCODETYPE ,
