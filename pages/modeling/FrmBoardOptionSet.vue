<template>
  <div>
    <ol class="page-navigation">
      ...
      <!-- 기준정보 -->
      <li>{{ $t('MES_CommLang.MES_CommLang_00837') }}</li>
      <!-- IPC 옵션관리 -->
    </ol>
              ...
              <CardBody :style="{ width: '100%', height: '100%' }">
                <v-row no-gutters>
                  <v-col cols="4" align="left">
                    <CardTitle>{{
                      $t('MES_CommLang.MES_CommLang_00838')
                    }}</CardTitle>
                    <!-- 설정목록 -->
                  </v-col>
              ...
              <CardBody :style="{ width: '100%', height: '100%' }">
                <v-row no-gutters>
                  <v-col cols="6" align="left">
                    <CardTitle>{{
                      $t('MES_CommLang.MES_CommLang_00839')
                    }}</CardTitle>
                    <!-- 상세설정 -->
                  </v-col>
                  <v-col cols="6" align="right">
                    ...
                    <Button
                      ...
                      :icon="'undo'"
                      @click="resetBtn"
                      >{{ $t('MES_CommLang.MES_CommLang_00840') }}
                    </Button>
                  </v-col>
                </v-row>
                <div>
                          ...
                          <div class="m-3">
                            <div style="display: inline-block; width: 40%">
                              <div
                                ...
                                "
                                :style="{
                                  backgroundColor: beforeBack,
                                  color: beforeFont,
                                }"
                              >
                                {{ $t('MES_CommLang.MES_CommLang_00842') }}
                              </div>
                              <!-- 작업전 -->
                            </div>
                            <p style="display: inline-block">
                              {{ $t('MES_CommLang.MES_CommLang_00843') }} :
                            </p>
                            <ColorPicker
                              :ref="beforeBack"
                              v-model="beforeBack"
                            ...
                            />
                            <p style="display: inline-block">
                              {{ $t('MES_CommLang.MES_CommLang_00844') }} :
                            </p>
                            <ColorPicker
                              :ref="beforeFont"
                              v-model="beforeFont"
                          ...
                          <div class="m-3">
                            <div style="display: inline-block; width: 40%">
                              <div
                                ...
                                "
                                :style="{
                                  backgroundColor: workingBack,
                                  color: workingFont,
                                }"
                              >
                                {{ $t('MES_CommLang.MES_CommLang_00845') }}
                              </div>
                              <!-- 작업중 -->
                            </div>
                            <p style="display: inline-block">
                          ...
                          <div class="m-3">
                            <div style="display: inline-block; width: 40%">
                              <div
                                ...
                                "
                                :style="{
                                  backgroundColor: afterBack,
                                  color: afterFont,
                                }"
                              >
                                {{ $t('MES_CommLang.MES_CommLang_00846') }}
                              </div>
                              <!-- 작업후 -->
                            </div>
                            <p style="display: inline-block">
                          ...
                          <div class="m-3">
                            <div style="display: inline-block; width: 40%">
                              <div
                                ...
                                "
                                :style="{
                                  backgroundColor: pauseBack,
                                  color: pauseFont,
                                }"
                              >
                                {{ $t('MES_CommLang.MES_CommLang_00847') }}
                              </div>
                              <!-- 작업중단 -->
                            </div>
                            <p style="display: inline-block">
                          ...
                          <div class="m-3">
                            <div style="display: inline-block; width: 40%">
                              <div
                                ...
                                "
                                :style="{
                                  backgroundColor: stopBack,
                                  color: stopFont,
                                }"
                              >
                                {{ $t('MES_CommLang.MES_CommLang_00848') }}
                              </div>
                              <!-- 비가동 -->
                            </div>
                            <p style="display: inline-block">
                          ...
                          <div class="m-3">
                            <div style="display: inline-block; width: 40%">
                              <div
                                ...
                                "
                                :style="{
                                  backgroundColor: nextBack,
                                  color: nextFont,
                                }"
                              >
                                {{ $t('MES_CommLang.MES_CommLang_00849') }}
                              </div>
                              <!-- 익일작지 -->
                            </div>
                            <p style="display: inline-block">
                      ...
                      >
                        ...
                        <v-col :cols="8" style="display: inline-block">
                          <v-row>
                            ...
                            >
                              <p style="margin: 0">
                                {{ $t('MES_CommLang.MES_CommLang_00851') }}
                              </p>
                            </v-col>
                          </v-row>
                        </v-col>
...
export default {
  ...
  methods: {
      ...
      const saveData = this.gridData
        ...
        .map(x => {
          return {
            ...
            WORKCENTER:
              x.rowStat != 'C'
                ? this.comboList.filter(y => y.ENUMVALUENAME == x.WORKCENTER)[0]
                    .ENUMVALUE
                : x.WORKCENTER,
          };
        });
    ...
    resetBtn() {
      this.resetColors();
      this.$refs['visualRate'].textVal = this.gridData.filter(
        x => x.selected == true
      )[0].VISUALRATE;
      this.$refs['nextCount'].textVal = this.gridData.filter(
        x => x.selected == true
      )[0].NEXTCOUNT;
      this.setColors(this.gridData.filter(x => x.selected == true)[0]);

      let currentData = this.gridData
        .filter(x => x.idx == this.selectedIdx)
        .map(x => {
          return {
            ...x,
            selected: '',
      ...
      if (
        this.gridData.filter(x => x.idx == this.selectedIdx)[0].rowStat !=
          'C' &&
        this.gridData.filter(x => x.idx == this.selectedIdx)[0].rowStat != 'D'
      ) {
    ...
    rowDdChange(e, name, dataItem) {
      ...
      let wcName = this.comboList.filter(x => x.ENUMVALUE == e.value)[0]
        .ENUMVALUENAME;
      ...
      this.gridData = this.gridData.map(x => {
        return {
          ...
          WORKCENTERNAME:
            x.idx == dataItem.idx
              ? this.comboList.filter(x => x.ENUMVALUE == e.value)[0]
                  .ENUMVALUENAME
              : x.WORKCENTERNAME,
        };
      });
    ...
    selectedRow(row) {
      ...
      this.gridData = this.gridData.map(x => {
        return {
          ...x,
          MANAGEMENTID:
            this.btnClickIdx == x.idx ? row.EQUIPMENTID : x.MANAGEMENTID,
          MANAGEMENTNAME:
            this.btnClickIdx == x.idx ? row.EQUIPMENTNAME : x.MANAGEMENTNAME,
        };
      });
    ...
    gridButtonClick(e, field, dataItem) {
      if (field === 'MANAGEMENTBUTTON') {
        ...
        console.log(
          'gridButtonclick - btnclickIdx',
          this.gridData.filter(x => x.idx == this.btnClickIdx)[0]
        );
        if (
          this.gridData.filter(x => x.idx == this.btnClickIdx)[0].WORKCENTER ==
          undefined
        ) {
          this.$refs.alertPop.show(
            this.$i18n.t('MES_CommLang.MES_CommLang_00456'),
            this.$i18n.t('MES_MsgLang.MES_MsgLang_00223')
          ); /* 알림, Workcenter를 선택해주세요. */
          return;
        }
