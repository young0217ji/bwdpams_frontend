<template>
  <div>
    <ol class="page-navigation">
      ...
      <!-- 공정관리 -->
      <li>{{ $t('MES_CommLang.MES_CommLang_00667') }}</li>
      <!-- 생산이상현황 모니터링 -->
    </ol>
            ...
            <v-row ref="searchFilter" no-gutters>
              <v-col :sm="9" :lg="10">
                <div class="form-group-wrap">
                  ...
                  <div class="form-group" style="margin-left: 5px">
                    <label>{{ $t('MES_CommLang.MES_CommLang_00668') }}</label>
                    <!-- 생산이상유형 -->
                    <DropDownList
                      ref="cmbalarmid"
                      :style="{ width: '200px' }"
            ...
            <v-row ref="searchFilter" style="margin-top: 10px">
              <v-col :sm="9" :lg="10">
                <div class="form-group-wrap">
                  ...
                  >
                    <label>{{ $t('MES_CommLang.MES_CommLang_00669') }}</label>
                    <!--발생일-->
          ...
          <CardBody :style="{ width: '100%', height: '100%' }">
            <v-row no-gutters>
              <v-col cols="6" align="left">
                <CardTitle>{{
                  $t('MES_CommLang.MES_CommLang_00670')
                }}</CardTitle>
                <!-- 생산이상현황 목록 -->
              </v-col>
            </v-row>
