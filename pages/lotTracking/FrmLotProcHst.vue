...
import SelectConsumableHistory from '../../components/frmLotProcHst/SelectConsumableHistory.vue';
...
export default {
  ...
  data() {
    return {
      ...
      tabs: [
        {
          title: this.$i18n.t('MES_CommLang.MES_CommLang_00018'),
          content: 'LotProcessHistory',
        },
        {
          title: this.$i18n.t('MES_CommLang.MES_CommLang_00254'),
          content: 'ReworkInformationList',
        },
      ],
      selectedTab: 0,
    };
    ...
    popDetailView() {
      if (!this.selectedLot) {
        this.$refs.alertPop.show(
          '',
          this.$i18n.t('MES_MsgLang.MES_MsgLang_00009')
        );
        this.alertCallBack = () => {};
        return;
      }
          ...
          .then(res => {
            if (!res) {
              ...
              this.$refs.alertPop.show(
                ...
                this.$refs.alertPop.show(
                  '',
                  this.$i18n.t('MES_MsgLang.MES_MsgLang_00152')
                )
              );
              return;
            }
