          ...
          <CardBody :style="{ width: '100%', height: '100%' }">
            <v-row no-gutters>
              <v-col cols="6" align="left">
                <CardTitle>{{
                  $t('MES_CommLang.MES_CommLang_00813')
                }}</CardTitle>
                <!-- 작업 실적 목록 -->
              </v-col>
...
import EquipmentModal from '@/components/frmPaintingProc/EquipmentModal.vue';
...
export default {
  ...
  methods: {
    ...
    toChange(e) {
      ...
      this.startDate = Utility.setFormatDate(
        new Date(
          Utility.setFormatDate(e.value, 'YYYY'),
          Utility.setFormatDate(e.value, 'MM') - 1,
          Utility.setFormatDate(e.value, 'DD') - 3
        ),
        'YYYY-MM-DD'
      );
    },
