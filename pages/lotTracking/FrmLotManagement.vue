          ...
          <CardBody>
            <v-row no-gutters>
              <v-col :sm="8" :lg="9">
                <div class="form-group-wrap">
                  <div class="form-group">
                    ...
                    />
                    <Button :theme-color="'secondary'" :size="'medium'" @click="searchModalVisible = true" >{{ $t("MES_CommLang.MES_CommLang_00086") }}</Button>
                  </div>
                  <div class="form-group">
              ...
              <v-col :sm="2" :lg="3" align="right">
                <Button :theme-color="'primary'" :size="'medium'" icon="search" @click="searchBtn">{{ $t("MES_CommLang.MES_CommLang_00277") }}</Button>
...
import SelectModelingConfirm from "@/components/frmLotManagementTabs/SelectModelingConfirm";
import Hold from "@/components/frmLotManagementTabs/Hold";
import Release from "@/components/frmLotManagementTabs/Release";
import LotScrap from "@/components/frmLotManagementTabs/LotScrap";
import LotUnScrap from "@/components/frmLotManagementTabs/LotUnScrap";
...
export default {
  ...
  methods: {
    ...
    saveCallBack(callback) {
      if(callback){
        this.$refs.alertPop.show("Info", this.$i18n.t('MES_MsgLang.MES_MsgLang_00140'));
      } else {
