<template>
    <div>
        <ol class="page-navigation">
            ...
            <li>{{ $t("MES_CommLang.MES_CommLang_00814") }}</li> <!-- 작업실적 이력 조회 -->
        </ol>
                        ...
                        <v-row no-gutters>
                            <v-col :sm="9" :lg="10">
                                <div class="form-group-wrap">
                                    ...
                                    <div class="form-group">
                                        <label>{{ $t("MES_CommLang.MES_CommLang_00237") }}</label> <!-- 조회기간 -->
        ...
        <v-row ref="contents">
            <v-col :cols="12" :class="'divListWapper'" :style="{ height: '50%' }">
                <Card ref="gridCard" :style="{ height: '100%' }">
                    <CardBody :style="{ width: '100%', height: '100%' }">
                        <v-row no-gutters>
                            <v-col cols="6" align="left">
                                <CardTitle>{{ $t("MES_CommLang.MES_CommLang_00815") }}</CardTitle> <!-- 작업실적 이력 목록 -->
                            </v-col>
                        </v-row>
            ...
            <v-col :cols="12" :class="'divListWapper'" :style="{ height: '50%' }">
                <Card ref="gridCard" :style="{ height: '100%' }">
                    <CardBody :style="{ width: '100%', height: '100%' }">
                        <v-row no-gutters>
                            <v-col cols="6" align="left">
                                <CardTitle>{{ $t("MES_CommLang.MES_CommLang_00815") }}</CardTitle> 
                            </v-col>
                        </v-row>
                        <div ref="divWrapper" :style="{ height: 'calc(100% - 33px)' }">
                            <KendoGrid ref="rowGrid" :gridHeight="gridHeight" :gridItems="gridData"
