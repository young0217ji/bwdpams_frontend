<template>
    <div>
        <ol class="page-navigation">
            ...
            <li>{{ $t("MES_CommLang.MES_CommLang_00689") }}</li> <!-- MES Lot 이력 조회 -->
        </ol>
        ...
        <v-row ref="contents">
            ...
            <v-col :sm="12" :lg="2" :class="'divListWapper2'" :style="{ height: '50%' }">
                <Card ref="gridCard" :style="{ height: '100%' }">
                    <CardBody :style="{ width: '100%', height: '100%' }">
                        <v-row no-gutters>
                            <v-col cols="6" align="left">
                                <CardTitle>{{ $t("MES_CommLang.MES_CommLang_00691") }}</CardTitle> <!-- Lot 목록 -->
                            </v-col>
                        </v-row>
            ...
            <v-col :sm="12" :lg="10" :class="'divListWapper3'" :style="{ height: '50%' }">
                <Card ref="gridCard" :style="{ height: '100%' }">
                    <CardBody :style="{ width: '100%', height: '100%' }">
                        <v-row no-gutters>
                            <v-col cols="6" align="left">
                                <CardTitle>{{ $t("MES_CommLang.MES_CommLang_00692") }}</CardTitle> <!-- Lot 이력 목록 -->
                            </v-col>
                        </v-row>
...
export default {
    ...
    methods: {
        ...
        async getGridData3(event){
            ...
            this.mesGet({
                apiKey: "mes/common/getqueryresult",
                queryId: "GetLotProcessHistoryList",
                queryVersion: '00001',
                sendParam: {
                    plantid: this.$auth.$state.user.plantId,
                    LOTID: event,
