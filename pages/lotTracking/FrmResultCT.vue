<template>
  <div>
    <ol class="page-navigation">
      ...
      <!-- 공정관리 -->
      <li>{{ $t('MES_CommLang.MES_CommLang_00899') }}</li>
      <!-- 실적C/T 조회 -->
    </ol>
...
export default {
  ...
  data() {
    return {
      ...
      tabs: [
        {
          title: this.$i18n.t('MES_CommLang.MES_CommLang_00902'),
          content: 'Case',
        } /* 건 별 */,
        {
          title: this.$i18n.t('MES_CommLang.MES_CommLang_00258'),
          content: 'Product',
        } /* 품번 */,
        {
          title: this.$i18n.t('MES_CommLang.MES_CommLang_00903'),
          content: 'DayAvg',
        } /* 기간 평균 */,
      ],
      selected: 0,
