<template>
  <div>
    <ol class="page-navigation">
      ...
      <!-- 설비관리 -->
      <li>{{ $t('MES_CommLang.MES_CommLang_00646') }}</li>
      <!-- 긴급보전 요청관리 -->
    </ol>
            ...
            <v-row no-gutters>
              ...
              <v-col cols="6" align="right">
                <Button
                  ...
                  icon="delete"
                  @click="holdBtn"
                  >{{ $t('MES_CommLang.MES_CommLang_00475') }}</Button
                >
                <!-- 보류 -->
                <Button
                  :theme-color="'primary'"
                  ...
                  icon="delete"
                  @click="rejectBtn"
                  >{{ $t('MES_CommLang.MES_CommLang_00647') }}</Button
                >
                <!-- 반려 -->
                <Button
                  :theme-color="'primary'"
                  ...
                  icon="save"
                  @click="completeBtn"
                  >{{ $t('MES_CommLang.MES_CommLang_00495') }}</Button
                >
                <!-- 완료 -->
              </v-col>
            </v-row>
          ...
          <Card ref="gridCard" :style="{ height: '100%' }">
            <CardBody :style="{ width: '100%', height: '100%' }">
              <v-row no-gutters>
                <v-col cols="6" align="left">
                  <CardTitle>{{
                    $t('MES_CommLang.MES_CommLang_00648')
                  }}</CardTitle>
                  <!-- 작업 설명 -->
                </v-col>
                <v-col cols="6" align="right">
                  <Button
                    ...
                    icon="add"
                    @click="sparePartBtn"
                    >{{ $t('MES_CommLang.MES_CommLang_00649') }}</Button
                  >
                  <!-- 사용자재 입력 -->
                </v-col>
              </v-row>
              <div class="detail-area">
                <div class="left-area">
                  ...
                  <div class="area-form">
                    <div class="area-th">
                      <label>{{ $t('MES_CommLang.MES_CommLang_00650') }}</label>
                      <!-- 요청시간 -->
                    </div>
                    <div class="area-td area-full">
                      <!-- 3칸 : area-full -->
              ...
              <div class="detail-area" style="margin-top: 5px">
                <div class="area-form" style="height: 100px">
                  <div class="area-th">
                    <label>{{ $t('MES_CommLang.MES_CommLang_00648') }}</label>
                    <!-- 작업설명 -->
                  </div>
    ...
    <InputSparePartModal
      ...
      v-if="inputSparePartModalVisible"
      :visibleDialog="inputSparePartModalVisible"
      :title="inputSparePartModalTitle"
      :selected-field="selectedField"
      :initData="initData"
...
export default {
  ...
  async mounted() {
    this.inputSparePartModalTitle = this.$i18n.t(
      'MES_CommLang.MES_CommLang_00649'
    ); /* 사용자재 입력 */
  ...
  methods: {
        ...
        .map(x => {
          return {
            ...
            WORKTIME:
              ...
              this.intputRequestDateHHMMSS.replaceAll(':', ''), // 작업시간
          };
        });
    ...
    //사용자재 입력 버튼 클릭
    sparePartBtn() {
      const selectedData = this.gridData2.filter(x => x.selected === true);
      ...
      if (selectedData.length > 0) {
        ...
        this.$refs.alertPop.show(
          this.$i18n.t('MES_CommLang.MES_CommLang_00456'),
          this.$i18n.t('MES_MsgLang.MES_MsgLang_00253')
        ); /* 알림, 요청 데이터를 선택해주세요. */
      }
    },
    //   cancelModalVisible(){
