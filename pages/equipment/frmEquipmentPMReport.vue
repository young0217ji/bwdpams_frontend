<template>
  <div>
    <ol class="page-navigation">
      ...
      <li>{{ $t("MES_CommLang.MES_CommLang_00610") }}</li> <!-- 예방보전 실적조회 -->
    </ol>
          ...
          <CardBody :style="{ width: '100%', height: '100%' }">
            <v-row no-gutters>
              <v-col cols="6" align="left">
                <CardTitle>{{ $t("MES_CommLang.MES_CommLang_00611") }}</CardTitle> <!-- 예방보전 목록-->
              </v-col>
            ...
            <div ref="divWrapper2" style="height: calc(100% - 33px);">
              <KendoGrid ref="PMReport" :gridHeight="gridHeight" :gridItems="gridDataPMReport" :sortable="true" :gridPageData="gridPageData"
                :columns="PMReportParam.gridHeader" :resizable="true" :isPaging="true" :selected-field="selectedField"
