<template>
  <div>
    <ol class="page-navigation">
      ...
      <!-- 설비관리 -->
      <li>{{ $t('MES_CommLang.MES_CommLang_00617') }}</li>
      <!-- 예방보전 일정조회 -->
    </ol>
                ...
                <div class="form-group-wrap">
                  <div class="form-group form-calendar-month">
                    ...
                    <div class="dp-calendar">
                      <span ref="labelYear" class="i-year" value="">{{
                        year
                      }}</span>
...
import PMSchedule from '@/components/frmPMMgmtTabs/FrmPMScheduleTab';
import PMWork from '@/components/frmPMMgmtTabs/FrmPMWorkTab';
  ...
  data() {
    return {
      ...
      tabs: [
        /* 예방보전일정, 예방보전 작업 */
        {
          title: this.$i18n.t('MES_CommLang.MES_CommLang_00034'),
          content: 'PMSchedule',
        }, // title: 탭명, content: v-slot:PMSchedule
        {
          title: this.$i18n.t('MES_CommLang.MES_CommLang_00035'),
          content: 'PMWork',
        },
      ],
      gridHeight:
  ...
  methods: {
    ...
    searchBtn() {
      ...
      if (this.selected === 0) {
        ...
        let labelYearMonth = Utility.setFormatDate(
          this.year + this.month,
          'YYYYMM'
        );
        this.$refs.PMWork.getGridData(
          labelYearMonth,
          this.equipmentId,
          this.workUser
        );
    ...
    openPMWorkTab(clickData, btnFlag) {
      ...
      this.paramPMScheduleDate = Utility.setFormatDate(
        this.startPMData[0].pmplannedtime.replaceAll('-', ''),
        'YYYYMMDD'
      );
        ...
        this.$refs.PMWork.gridData
          ...
          .map(x => {
            ...
            if (this.startPMData[0].pmscheduleid === x.PMSCHEDULEID) {
              this.$refs.PMWork.gridData[x.idx].selected =
                !this.$refs.PMWork.gridData[x.idx].selected;
            }
          });
      }
