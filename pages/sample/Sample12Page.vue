...
import SampleCustomCell from './SampleCustomCell';
import SampleDragClue from './SampleDragClue';
import { reorderData, getTargetTopOffSet  } from './SampleGridReorderMinin.js';

export default {
    components: {
        'Grid': Grid,
        'custom': SampleCustomCell,
        'dragclue': SampleDragClue,
        reorderData, 
        getTargetTopOffSet
    },
   data () {
        return {
            ...
            items: [],
            columns: [
                { field: 'reorder', title: '', width: '80px', title: '드래그' },
                { field: 'ProductID'},
