<template>
    <div>
        <ol class="page-navigation">
            ...
            <li>{{ $t("MES_CommLang.MES_CommLang_00916") }}</li> <!--공지사항-->
        </ol>
                            ...
                            <v-col :sm="9" :lg="10" align="left">
                                <div class="form-group-wrap">
                                    <div class="form-group">
                                        ...
                                        <inputText ref="title" :boxWidth="'100%'" :dataNm="'title'" :disabled="false"
                                ...
                                <Button :theme-color="'secondary'" :size="'medium'"  @click="writeCall">{{ $t("MES_CommLang.MES_CommLang_00917") }}</Button> <!-- 글작성 -->
                    ...
                    <CardBody :style="{ width: '100%' }">
                        <v-row no-gutters>
                            <v-col cols="6" align="left">
                                <CardTitle>{{ $t("MES_CommLang.MES_CommLang_00918") }}</CardTitle>   <!-- 글목록 -->
                            </v-col>
                        ...
                        <div ref="divWrapper" :style="{ height: 'calc(100% - 33px)' }">
                            <KendoGrid ref="rowGrid" 
                                :gridItems="gridData" :sortable="true"
...
import writePopUp from "@/components/frmNotice/writePopUp";
...
export default {
    ...
    data() {
        return {
            ...
            title: '',
            startDate: Utility.setFormatDate(new Date(year-1, month,day), "YYYY-MM-DD"),
    ...
    methods: {
        ...
        async getGridData() {
            ...
            this.mesGet({
                ...
                queryId: "GetNoticeList",
                queryVersion: '00001',
                sendParam: {
                    plantid: this.$auth.$state.user.plantId,
                    TITLE: this.title,
                    STARTDATE: Utility.setFormatDate(this.startDate, 'YYYY-MM-DD'),
                    ENDDATE: Utility.setFormatDate(this.endDate, 'YYYY-MM-DD') + " 23:59:59",
                    skip: skip,
                    take: take,
                },
            }).then(({ list, paging, ...x }) => {
