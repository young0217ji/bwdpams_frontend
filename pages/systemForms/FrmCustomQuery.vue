<template>
    <div>
        <ol class="page-navigation">
            ...
            <li>{{ $t("MES_CommLang.MES_CommLang_00593") }}</li> <!--Query편집기-->
        </ol>
                            ...
                            <v-col :sm="9" :lg="10">
                                <div class="form-group-wrap">
                                    <div class="form-group">
                                        ...
                                        <InputText ref="inputQueryid" :dataNm="'inputQueryid'" :disabled="false"
                                            :searchOption="true" :searchFunc="searchBtn" @input-text-set="searchInput" />
                                    </div>
                                </div>
                            </v-col>
                            <v-col :sm="3" :lg="2" align="right">
                                <kbutton :theme-color="'primary'" :size="'medium'" :icon="'search'" @click="searchBtn">{{ $t("MES_CommLang.MES_CommLang_00277") }} <!--조회-->
                                </kbutton>
                            </v-col>
                        </v-row>
                    </CardBody>
                ...
                <v-row :style="{ height: '100%' }">
                            ...
                            <CardBody :style="{ width: '100%', height: '100%' }">
                                <v-row no-gutters>
                                    ...
                                    <v-col cols="6" align="right">
                                        <kbutton :theme-color="'primary'" :size="'small'" :icon="'save'" @click="saveBtn">{{ $t("MES_CommLang.MES_CommLang_00414") }} <!--저장-->
                                        </kbutton>
                                        <kbutton
                                        ...
                                        >페이지EXCEL</kbutton
                                        >
                                        <kbutton :theme-color="'secondary'" :size="'small'" :icon="'add'" @click="addBtn">{{ $t("MES_CommLang.MES_CommLang_00411") }} <!--추가-->
                                        </kbutton>
                                        <kbutton :theme-color="'secondary'" :size="'small'" :icon="'delete'"
                                            @click="confirmDel">{{ $t("MES_CommLang.MES_CommLang_00412") }} <!--삭제-->
                                        </kbutton>
                                ...
                                <div ref="divWrapper" :style="{ height: 'calc(100% - 33px)' }">
                                    <KendoGrid ref="rowGrid" :gridHeight="gridHeight" :gridItems="gridData" :sortable="true"
                                        ...
                                        @selectionchange="onSelectionchange" @gridrowclick="onRowClick"
                    ...
                    <v-col :cols="12" :class="'divList2'" :style="{ height: '40%' }">
                        <v-row class="search-box" align="center" no-gutters>
                            ...
                            <v-col :cols="11">
                                <TextArea ref="queryString" :style="{ width: '100%', height: '300px' }"
...
export default {
    ...
    methods: {
        ...
        searchBtn() {
            ...
            this.selected= '';
            if (this.$refs['queryString'].currentValue = this.gridData.QUERYSTRING) {
